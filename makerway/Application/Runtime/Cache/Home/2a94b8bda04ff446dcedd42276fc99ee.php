...
<div class="content">
	<div class="title">
		...
		<img src="/passon/Public/images/title.png"/>
	...
	<div class="main">
		<div class="img-li">
			<ul>
				<li>
					<img src="/passon/Public/images/1.jpg"/>
				</li>
				<li>
					<img src="/passon/Public/images/2.jpg"/>
				</li>
				<li>
					<img src="/passon/Public/images/3.jpg"/>
				</li>
				<li>
					<img src="/passon/Public/images/4.jpg"/>
				</li>
			</ul>
		</div>
	</div>
	<div class="footer">
		<div class="pass">Maker Way</div>
		<span>联系邮箱：pass.on@foxmail.com</span>
		<div class="footer-img">
			<img src="/passon/Public/images/m2.jpg"/>
		</div>
...
<script type="text/javascript" src="/passon/Public/js/index.js"></script>
<script type="text/javascript" src="/passon/Public/js/labelsearch.js"></script>
<script type="text/javascript" src="/passon/Public/js/submit.js"></script>
<script>
