    ...
    <div class="head">
        <div class="title">
            ...
            <!--</span>-->
                <span class="username-list">
                    <ul>
                        <li class="register"><a href="<?php echo U(bookinfoRegister,array('book_id'=>$book['book_id']));?>">注册</a></li>
                        <li class="login"><a href="<?php echo U(bookinfoLogin,array('book_id'=>$book['book_id']));?>">登录</a></li>
                    </ul>
                </span>
    ...
    <div class="main">
        ...
        <div class="main-left">
            <div class="left-body">
                ...
                <?php else: ?>
                    <span>分享者:<?php echo ($book['owner_name']); ?></span>
                <?php endif ?>
                <span>点赞数</span>
                <!--<span>评论数</span>-->
                ...
                <div class="body-message">
                    ...
                    <div class="comment" style="display: none">
                        <div class="book-comment">
                            <div class="comment-num">2条书评</div>
                            <div class="comment-message">写书评</div>
                        </div>
                        <div class="comment-comment">
                            <div class="do-comment">
                                <div class="comment-title"><span>给这本书打个分吧!(可选)</span><span>ss</span></div>
                                <div class="comment-top">书评内容：</div>
                                <form name="form" action="<?php echo U(bookcomment);?>" method="post">
                                    <div class="textarea">
                            ...
                            <ul>
                                <?php if(is_array($bookcomment)): foreach($bookcomment as $key=>$item): ?><li>
                                        <div class="main-bookcomment">
                                            ...
                                            <span class="comment-span">人赞同</span>
                                            <span class="com-n">条评论</span>
                                            <!--<span>人分享</span>-->
                                        </div>
                                        <div class="comment-comment-ul">
                                            <ul>
                                                <?php foreach ($item['comment1'] as $item): ?>
                                                <li>
                                                    <div class="main-comment-comment">
                                                        <img src=""/>
                                                        <span class="c-n"><?php echo ($item['username']); ?></span>
                                                        <span class="c-c"><?php echo ($item['comment']); ?></span>
                                                        <span class="c-time color"><?php echo ($item['time']); ?></span>
                                                    </div>
                                                </li>
                                                <?php endforeach ?>
                                                <form name="form" action="<?php echo U(cComment);?>" method="post">
                                                    <input class="write" name="input" placeholder="写下你的评论"/><br/>
                                                    <input class="write-button" type="submit" name="submit" value="发表" />
                                                    <input class="exit" style="display: none" type="text" name="commentid" value=<?php echo ($item['comment_id']); ?> />
                                                    <input class="exit" style="display: none" type="text" name="bookid" value=<?php echo ($book['book_id']); ?> />
                                                </form>
                                            </ul>
                                        </div>
