define('lib/letv_analytics_cn', function(require, exports, module) {
    (function() {
    ...
    function letvAlysInit(product, platform, country, userid_key, ext, property) {
        ...
        var clientId = 'uid=' + uid + '&letvcookie=' + tj2_lc + '&platform=' + platform + '&cpsid=' + cpsid + '&sourceUrl=' + sourceUrl + '&sid=' + sid + '&eid=' + tj_lc +
    ...
    exports.letvAlyStart = letvAlyStart;
    exports.letvAlysSendAction = letvAlysSendAction;
});
