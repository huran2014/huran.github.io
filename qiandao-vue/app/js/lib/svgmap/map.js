 ...
 */
define('lib/svgmap/map', function(require, exports, module) {
    var jQuery = require('jquery');
    var Raphael = require('lib/svgmap/raphael');
    return function(win, $, undefined) {
        return (function() {
            ...
            SVGMap.prototype.options = {
                ...
                mapWidth: 500,
                mapHeight: 400,
                stateColorList: ['2E4400', '3E5703', '537407', '71A400', '92C122', 'ADE035', 'CDF771'],
            ...
            SVGMap.prototype.render = function(config) {
                ...
                var offsetXY = function(e) {
                    var mouseX, mouseY, tipWidth = $('.L_city').outerWidth(),
                        tipHeight = $('.L_city').outerHeight();
                    if (e && e.pageX) {
                        mouseX = e.pageX;
                        mouseY = e.pageY;
                    } else {
                    ...
                    if (stateData[state] && stateData[state].diabled) {
                        ...
                        obj.hover(function(e) {
                            ...
                            if (opt.showTip) {
                                ...
                                if ($('.L_city').length == 0) {
                                    $(document.body).append('<div class="L_city"></div');
                                }
                                $('.L_city').html(opt.stateTipHtml(stateData, this));
